...
===== dans nginx.conf (127.0.0.1 ou  devise.api.service , 8282 ou ...)  ==== dans image docker ====
...
pour debug :
ping -c 2 devise.api.service
curl http://devise.api.service:8282/deviseApi/rest/public/devises
