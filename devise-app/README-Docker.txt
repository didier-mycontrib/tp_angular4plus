...
===== dans nginx.conf (127.0.0.1 ou  devise.api.host , 8282 ou ...)  ==== dans image docker ====
    ...
    location  ~ ^/devise-app/deviseApi/(.*){
            resolver 127.0.0.11;
            proxy_pass   http://devise.api.host:8282/deviseApi/$1?$args;
    }
...
curl http://devise.api.host:8282/deviseApi/rest/public/devises
